...
void updatePID() {
	...
	if (elapsedTime < 7500){
		angleCorrection = kPw * angleError + kDw * (angleError - oldAngleError) + .0003;
		oldAngleError = angleError;
	}
	else {
		angleCorrection = kPw * angleError + kDw * (angleError - storeNewAngleError(angleError)) + .0003;
	}
...
int storeNewAngleError(int newAngleError){
